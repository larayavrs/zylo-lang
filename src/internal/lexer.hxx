...
/**
 * @namespace zylo_lexer
 * @brief Contains the lexer and related components for the Zylo programming language.
 *
 * This namespace includes the lexer and structures used to tokenize the source code
 * for the Zylo programming language. It provides functionality for breaking down
 * the source code into meaningful units called tokens, which are then processed
 * by other components of the language.
 */
namespace zylo_lexer
{
    /**
    ...
    struct TokenIdentifier
    {
         ...
         */
        static TokenIdentifier tokenIdentifiers[static_cast<int>(TokenType::Invalid) + 1];
    };
